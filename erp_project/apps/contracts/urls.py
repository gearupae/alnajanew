...
urlpatterns = [
    ...
    path('types/', views.ContractTypeListView.as_view(), name='type_list'),
    path('types/<int:pk>/edit/', views.ContractTypeUpdateView.as_view(), name='type_edit'),
    path('types/<int:pk>/', views.ContractTypeDetailView.as_view(), name='type_detail'),
